...
public class SqlOrchestrationServiceSettings
{
    ...
    /// </summary>
    [JsonPropertyName("maxConcurrentActivities")]
    ...
    /// </remarks>
    [JsonPropertyName("maxActiveOrchestrations")]
